...
<div id="content">
  ...
  <script type="text/javascript">
    ...
    function addWebhook() {
      $.ajax({
        url: 'index.php?route=payment/paypal_plus/listWebhooksEventTypes&token=<?php echo $token; ?>', dataType: 'json',
        beforeSend: function() {
    ...
    $("#btn-send").click(function() {
      ...
      if (webhooks.length > 0) {
        $.ajax({
          url: 'index.php?route=payment/paypal_plus/addwebhooks&token=<?php echo $token; ?>',
          dataType: 'json',
          method: 'POST',
    ...
    function deleteWebhook(id) {
      bootbox.confirm({
        ...
        callback: function (result) {
          if (result === true) {
            $.ajax({
              url: 'index.php?route=payment/paypal_plus/deletewebhook&token=<?php echo $token; ?>',
              dataType: 'json',
              method: 'POST',
              data: { webhook_id: id },
              beforeSend: function() {
